...
### Response Scales
When using scales (e.g. Likert scales), avoid a neutral midpoint (e.g. "neither agree nor disagree") to encourage respondents to express a definite opinion. The answer will also not include a 7 as when users will tend towards a 7 out of 10 if possible, this is to seem fair but not mean. 
...
### Section 1 (about you)
1. What is your name
    - an open answer, but hopefully easy if the user knows their name
...
### Section 2 (back-end analyse)
1. What is the title of the course you are studying
    - Open answer, although kept short and easy
...
### Section 3 (rolsa account)
1. What was the email you used for the account
    - this question gets the user to make a copy of their fictitious email they used to review their account later
2. What was the password you used for the account
    - this question aims to get the user's fictitious password should the account need to be accessed later
...
As mentioned at the top of the document, the users were asked in turn to look at the website. In turn they were asked to user the website and answer the questions on the form. As an incentive they were offered a lollipop for completing the form.
